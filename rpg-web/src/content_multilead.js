  ...
  const SCENES = {
    ...
    start: {
      ...
      text:
        ...
        "你本可以不管。\n\n" +
        "可命运偏偏让你遇见了他。\n\n" +
        "你的每次选择，都将牵动他的心、你的心，以及这段说不清道不明的关系走向。",
      choices: [
      ...
      choices: [
        {
          label: "低声问他姓名",
          next: "C1_FEVER",
          effects: { stats: { affection_xie: +15, reputation: +1 } },
          tags: ["好感+15", "名声+1"],
        ...
        },
        {
          label: "什么也不问，先救人",
          next: "C1_FEVER",
          effects: { stats: { affection_xie: +10, reputation: +1 } },
          tags: ["好感+10", "名声+1"],
      ...
      choices: [
        {
          label: "守在他身边，一夜没走",
          next: "C1_N4",
          effects: { stats: { affection_xie: +20 } },
          tags: ["好感+20"],
        ...
        },
        {
          label: "低声问：那个名字，是谁",
          next: "C1_N4",
          effects: { stats: { affection_xie: +5, suspicion: +3 } },
          tags: ["好感+5", "怀疑+3"],
      ...
      choices: [
        {
          label: "深夜送药过来",
          next: "C1_N4",
          effects: { stats: { affection_xie: +5, suspicion: +1 } },
          tags: ["好感+5", "谨慎+1"],
        ...
        },
        {
          label: "等天亮再看",
          next: "C1_N4",
          effects: { stats: { affection_xie: -5, danger: +2 } },
          tags: ["好感-5", "危险+2"],
      ...
      choices: [
        {
          label: "把残玉放回他手边",
          next: "C1_N4",
          effects: { stats: { affection_xie: +5 }, flags: { have_jade: false } },
          tags: ["好感+5"],
    ...
    C1_N4: {
      ...
      choices: [
        ...
        },
        {
          label: "警告他：天亮必须离开",
          next: "C1_N5",
          effects: { stats: { affection_xie: -5, danger: -1 } },
          tags: ["好感-5", "危险-1"],
      ...
      choices: [
        {
          label: "把他藏进地窖",
          next: "C1_END",
          effects: { stats: { danger: -2, affection_xie: +5 } },
          tags: ["危险-2", "好感+5"],
        ...
        },
        {
          label: "编称是远房表兄探亲",
          next: "C1_END",
          effects: { stats: { reputation: +2, danger: +1, affection_xie: +8 } },
          tags: ["名声+2", "危险+1", "好感+8"],
        ...
        },
        {
          label: "让他自己应对，你去开门",
          next: "C1_END",
          effects: { stats: { affection_xie: -12, danger: +3 } },
          tags: ["好感-12", "危险+3"],
    ...
    C2_N1: {
      ...
      choices: [
        ...
        },
        {
          label: "请谢征出来周旋",
          next: "C2_N2C",
          effects: { stats: { affection_xie: +10, suspicion: +2 } },
          tags: ["好感+10", "怀疑+2"],
      ...
      choices: [
        {
          label: "提议趁夜送他出城",
          next: "C2_N4A",
          effects: { stats: { affection_xie: -10, danger: +2 } },
          tags: ["好感-10", "危险+2"],
        ...
        },
        {
          label: "同意假婚方案",
          next: "C2_N4B",
          effects: { stats: { affection_xie: +10 }, flags: { marriage: true } },
          tags: ["好感+10", "婚约=true"],
      ...
      choices: [
        {
          label: "重新考虑假婚方案",
          next: "C2_N4B",
          effects: { flags: { marriage: true } },
          log: "你看着那张画像，认了。拖延只会让局面更被动。",
        },
        {
          label: "问他：除了假婚，就没有别的办法了吗",
          next: "C2_N5",
          effects: { stats: { affection_xie: -3 } },
          tags: ["好感-3"],
    ...
    C2_RULES: {
      ...
      choices: [
        ...
        },
        {
          label: "反问他：万一你先食言呢",
          next: "C2_N5",
          effects: { stats: { affection_xie: +6, suspicion: +1 } },
          tags: ["好感+6", "怀疑+1"],
      ...
      choices: [
        {
          label: "接受假婚",
          next: "C2_RULES",
          effects: { stats: { affection_xie: +8 }, flags: { marriage: true } },
          tags: ["好感+8", "婚约=true"],
        ...
        },
        {
          label: "先不表态，但同意暂时配合",
          next: "C2_N5",
          effects: { stats: { affection_xie: -3, suspicion: +2 } },
          tags: ["好感-3", "怀疑+2"],
    ...
    C2_N5: {
      ...
      choices: [
        ...
        },
        {
          label: "拒绝办婚礼，只做表面文章",
          next: "C2_END",
          effects: { stats: { affection_xie: -6, rumor: +2 } },
          tags: ["好感-6", "流言+2"],
    ...
    C3_N1: {
      ...
      choices: [
        ...
        },
        {
          label: "请谢征一起出来帮衬门面",
          next: "C3_N2C",
          effects: { stats: { affection_xie: +10, rumor: -2, suspicion: +1 } },
    ...
    C3_N2B: {
      ...
      choices: [
        ...
        },
        {
          label: "问他：你有没有想出去的时候",
          next: "C3_N3",
          effects: { stats: { affection_xie: +8, suspicion: +1 } },
          tags: ["好感+8", "怀疑+1"],
    ...
    C3_N3: {
      ...
      choices: [
        ...
        },
        {
          label: "独吞线索，自己先查",
          next: "C3_N4C",
          effects: { stats: { affection_xie: -8, suspicion: +3 } },
          tags: ["好感-8", "怀疑+3"],
      ...
      choices: [
        {
          label: "伸手，轻轻放在他肩上",
          next: "C3_N5",
          effects: { stats: { affection_xie: +15 } },
          tags: ["好感+15"],
      ...
      choices: [
        {
          label: "低声呼叫谢征",
          next: "C3_ENDA",
          effects: { stats: { affection_xie: +15, danger: -3 }, flags: { alliance: true } },
      ...
      choices: [
        {
          label: "?????",
          next: "C4_ENDA_N1",
          effects: { flags: { c4_entry: "alliance" } },
          log: "?????????????????????",
        },
      ],
    },
    ...
    C4_ENDA_N1: {
      ...
      chapter: "??? ? ????",
      title: "????",
      image: "assets/cg/C4_ENDA_N1.png",
      text:
        "???????????????\n\n" +
        "???????????????????????????????????????????\n\n" +
        "??????????????????\n\n" +
    ...
    C4_ENDA_N2: {
      ...
      chapter: "??? ? ????",
      title: "????",
      image: "assets/cg/C4_ENDA_N2.png",
      text:
        "????????????\n\n" +
        "?????????????????????????????????????\n\n" +
        "????????????????????????????????\n\n" +
      ...
      choices: [
        {
          label: "?????????",
          next: "C4_N1_CAPITAL",
          effects: { stats: { affection_xie: +10 }, flags: { c4_entry: "alliance" } },
          tags: ["????+10"],
          log: "?????????????????????",
        },
      ],
    ...
    C4_ENDB_N1: {
      ...
      chapter: "??? ? ????",
      title: "?????",
      image: "assets/cg/C4_ENDB_N1.png",
      text:
        "?????????????\n\n" +
        "??????????????????????????????\n\n" +
        "?????????????????????????????????\n\n" +
    ...
    C4_ENDB_N2: {
      ...
      chapter: "??? ? ????",
      title: "?????",
      image: "assets/cg/C4_ENDB_N2.png",
      text:
        "????????????????????????????????\n\n" +
        "?????????????????????????\n\n" +
        "?????????\n\n" +
      ...
      choices: [
        {
          label: "????????????????",
          next: "C4_N1_CAPITAL",
          effects: { stats: { affection_xie: +10 }, flags: { alliance: true, c4_entry: "crack" } },
          tags: ["????+10", "??=true"],
          log: "?????????????????????",
        },
      ],
    ...
    C4_ENDC_N1: {
      ...
      chapter: "??? ? ????",
      title: "????",
      image: "assets/cg/C4_ENDC_N1.png",
      text:
        "?????????????\n\n" +
        "????????????????????????????????\n\n" +
        "???????????????????????????????????????????\n\n" +
      ...
      choices: [
        {
          label: "??????",
          next: "C4_ENDC_N2",
          effects: { stats: { affection_xie: +12 }, flags: { alliance: true } },
          tags: ["????+12", "??=true"],
          log: "???????????????????????",
        },
        {
          label: "????????????",
          next: "C4_ENDC_N2",
          effects: { stats: { suspicion: -1, affection_xie: +6 } },
          tags: ["??-1", "????+6"],
          log: "????????????????",
        },
      ],
    ...
    C4_ENDC_N2: {
      ...
      chapter: "??? ? ????",
      title: "????",
      image: "assets/cg/C4_ENDC_N2.png",
      text:
        "???????????????\n\n" +
        "????????????????????????????????????\n\n" +
        "????????????????\n\n" +
    ...
    C4_N1_CAPITAL: {
      ...
      chapter: "??? ? ????",
      title: "????",
      image: "assets/cg/C4_N1_CAPITAL.png",
      text: (state) => {
        const entry = state.flags?.c4_entry;
        const intro =
          entry === "alliance"
            ? "???????????????????????????????????????\n\n"
            : entry === "crack"
    ...
    C4_PEI_MEET: {
      ...
      chapter: "??? ? ????",
      title: "?????",
      image: "assets/cg/C4_PEI_MEET.png",
      text:
        "??????????????????????????????????????????????????????\n\n" +
        "????????????????????????????????????????????????\n\n" +
        "??????????????????????????????????\n\n" +
      ...
      choices: [
        {
          label: "???????????",
          next: "C4_PEI_TALK",
          effects: { stats: { affection_pei: +8, affection_xie: -2 } },
          tags: ["?????+8", "????-2"],
          log: "????????????????????",
        },
        {
          label: "????????????",
          next: "C4_PEI_TALK",
          effects: { stats: { affection_xie: +8, suspicion: +2 } },
          tags: ["????+8", "??+2"],
          log: "?????????????????????????",
        },
        {
    ...
    C4_PEI_TALK: {
      ...
      chapter: "??? ? ????",
      title: "????",
      image: "assets/cg/C4_PEI_TALK.png",
      text:
        "???????????????????????\n\n" +
        "??????????????????????????????????????????????????????????????????????????\n\n" +
        "??????????????????????????????????????????????????\n\n" +
      ...
      choices: [
        {
          label: "????????????????",
          next: "C4_BRANCH_PEI",
          effects: { stats: { affection_pei: +12, danger: -5 }, flags: { path: "pei" } },
          tags: ["?????+12", "??-5"],
          log: "??????????????????????????????",
        },
        {
          label: "????????????????",
          next: "C4_BRANCH_XIE",
          effects: { stats: { affection_xie: +12, danger: +4 }, flags: { path: "xie" } },
          tags: ["????+12", "??+4"],
          log: "???????????????????????????",
        },
        {
          label: "?????????????????",
          next: "C4_BRANCH_NEUTRAL",
          effects: { stats: { money: +2, property: +5 }, flags: { path: "neutral" } },
          tags: ["??+2", "????+5"],
          log: "???????????????????",
        },
      ],
    ...
    C4_BRANCH_PEI: {
      ...
      chapter: "??? ? ????",
      title: "?????",
      image: "assets/cg/C4_BRANCH_PEI.png",
      text:
        "?????????????????????????????????\n\n" +
        "????????????????????????????????????\n\n" +
        "?????????????????????????????????????????????????????\n\n" +
      ...
      choices: [
        {
          label: "???????????????????",
          next: "C4_END",
          effects: { stats: { affection_pei: +6, suspicion: -1 } },
          tags: ["?????+6", "??-1"],
          log: "???????????????????",
        },
      ],
    ...
    C4_BRANCH_XIE: {
      ...
      chapter: "??? ? ????",
      title: "????",
      image: "assets/cg/C4_BRANCH_XIE.png",
      text:
        "?????????????????????????????????\n\n" +
        "????????????????????????????????????????????\n\n" +
        "??????????????????????????????????????????\n\n" +
      ...
      choices: [
        {
          label: "??????????????",
          next: "C4_END",
          effects: { stats: { affection_xie: +6 }, flags: { alliance: true } },
          tags: ["????+6", "??=true"],
          log: "???????????????????????",
        },
      ],
    ...
    C4_BRANCH_NEUTRAL: {
      id: "C4_BRANCH_NEUTRAL",
      chapter: "??? ? ????",
      title: "????",
      image: "assets/cg/C4_BRANCH_NEUTRAL.png",
      text:
        "??????????????????????????\n\n" +
        "????????????????????????????????????????\n\n" +
        "??????????????????????????????????????????????????\n\n" +
      ...
      choices: [
        {
          label: "??????????????",
          next: "C4_END",
          effects: { stats: { reputation: +3, money: +1 } },
          tags: ["??+3", "??+1"],
          log: "??????????????????????",
        },
      ],
    ...
    C4_END: {
      ...
      chapter: "??? ? ????",
      title: "????",
      image: "assets/cg/C4_END.png",
      text: (state) => {
        const path = state.flags?.path;
        const outro =
          path === "pei"
            ? "??????????????????"
            : path === "xie"
